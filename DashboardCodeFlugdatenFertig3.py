 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "042577f9-bfb0-4a35-82c5-1a9c40926521",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x1ec20070830>"
      ]
     },
     "metadata": {},
   ...
   "source": [
    ...
    "import os\n",
    "\n",
    "# URL der CSV-Datei aus GitHub (RAW-Link verwenden!)\n",
    "csv_url = \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/flugdaten_verwendet.csv\"\n",
    "\n",
    "# Bilder-URLs aus GitHub (RAW-Links)\n",
    "image_urls = {\n",
    "    \"logo\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/Logo_Flughafen.jpg\",\n",
    "    \"coloured_stats\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/coloured_stats.jpg\",\n",
    "    \"home\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/home.jpg\",\n",
    "    \"logout\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/logout.jpg\",\n",
    "    \"settings\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/settings.jpg\",\n",
    "    \"stats\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/stats.jpg\",\n",
    "    \"stats_2\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/stats_2.jpg\",\n",
    "    \"user\": \"https://raw.githubusercontent.com/PatH00/DatInfoVis_Flugdaten/main/user.jpg\"\n",
    "}\n",
    "\n",
    "# CSV-Datei direkt aus GitHub laden\n",
    "df = pd.read_csv(csv_url, sep=\";\")\n",
    "\n",
    "# Fehlende Werte ersetzen\n",
    "df = df.replace(\"\", pd.NA)\n",
    "\n",
    "# Datum umwandeln und neue Spalten erstellen\n",
    ...
    "    children=[\n",
    "        dbc.Row([\n",
    "            dbc.Col(html.Img(src=image_urls[\"logo\"], className=\"img-fluid\", style={\"width\": \"100%\"}), width=4),\n",
    "            dbc.Col(\n",
    "                html.Div(\n",
    "                    [\n",
    ...
    "            dbc.Col(html.Div(\n",
    "                [\n",
    "                    html.Img(src=image_urls[\"home\"], className=\"mx-2 img-fluid\", style={\"height\": \"24px\"}),\n",
    "                    html.Img(src=image_urls[\"stats\"], className=\"mx-2 img-fluid\", style={\"height\": \"24px\"}),\n",
    "                    html.Img(src=image_urls[\"user\"], className=\"mx-2 img-fluid\", style={\"height\": \"24px\"}),\n",
    "                    html.Img(src=image_urls[\"logout\"], className=\"mx-2 img-fluid\", style={\"height\": \"24px\"})\n",
    "                 ],\n",
  ...
  },
  {
   ...
   "id": "36d82821-f7fc-48bc-a7fb-24376c996698",
   "metadata": {},
   "outputs": [],
   "source": []
  }
